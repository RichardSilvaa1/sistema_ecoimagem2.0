...
const RelationsList = () => {
  ...
  const fetchRelations = async () => {
    ...
    try {
      ...
      const res = await api.get(`/api/financas/relations${params ? `?${params}` : ''}`);
                ...
                <Box sx={{ position: 'relative', zIndex: 1 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      <LinkIcon sx={{ mr: 2, fontSize: '3rem' }} />
                      <Box>
                        <Typography variant="h4">
                          Relações Financeiras
                        </Typography>
                        <Typography variant="subtitle1" sx={{ opacity: 0.9 }}>
                          Gerencie as relações entre despesas e outros registros do sistema
                        </Typography>
                      </Box>
                    </Box>
                    <Box sx={{ display: 'flex', gap: 1 }}>
                  ...
                  <Card>
                    <CardContent sx={{ textAlign: 'center' }}>
                      <Typography variant="h4" sx={{ color: 'success.main', fontWeight: 700 }}>
                        {new Set(relations.map(r => r.expense_id)).size}
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
                  ...
                  <Card>
                    <CardContent sx={{ textAlign: 'center' }}>
                      <Typography variant="h4" sx={{ color: 'warning.main', fontWeight: 700 }}>
                        {new Set(relations.map(r => r.related_type)).size}
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
                        Tipos de Relação
                      </Typography>
                  ...
                  <Card>
                    <CardContent sx={{ textAlign: 'center' }}>
                      <Typography variant="h4" sx={{ color: 'error.main', fontWeight: 700 }}>
                        {hasActiveFilters ? 'Ativo' : 'Inativo'}
                      </Typography>
                      <Typography variant="body2" color="text.secondary">
                        Status do Filtro
                      </Typography>
              ...
              <Paper sx={{ overflow: 'hidden' }}>
                <Box sx={{ overflowX: 'auto' }}>
                  <Table>
                    <TableHead>
                      <TableRow>
                        <TableCell>ID da Despesa</TableCell>
                          ...
                          <TableRow>
                            <TableCell colSpan={5} align="center" sx={{ py: 8 }}>
                              <Box sx={{ textAlign: 'center' }}>
                                <LinkIcon sx={{ fontSize: '4rem', color: 'grey.400', mb: 2 }} />
                                ...
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                                  {hasActiveFilters 
                                    ...
                                    : 'Comece criando sua primeira relação'
                                  }
                                </Typography>
                                <Button
                                  variant="contained"
                            ...
                            >
                              ...
                              <TableCell>
                                <Typography variant="body2" sx={{ fontWeight: 500 }}>
                                  {rel.related_type || 'N/A'}
                                </Typography>
                              </TableCell>
                              <TableCell>
                                <Chip 
                                  label={`#${rel.related_id}`} 
                                  size="small" 
                                  color="secondary" 
                                  variant="outlined" 
                                />
                              ...
                              <TableCell align="center">
                                <Box sx={{ display: 'flex', gap: 1, justifyContent: 'center' }}>
                                  <Tooltip title="Visualizar">
                                    <IconButton
                                      size="small"
                                      onClick={() => navigate(`/relacoes/${rel.id}`)}
